...
/**
 * <p>Sms77ResponeMapper -- Filters for HTTP Status codes of the API</p>
 *
...
@Component
@XSlf4j
public class Sms77ResponeMapper {
    ...
    public ExchangeFilterFunction messageFilter() {
        log.entry();
        
        return log.exit(ExchangeFilterFunction.ofResponseProcessor(clientResponse -> {
            ...
            return log.exit(Mono.just(clientResponse));
        }));
    }
}
