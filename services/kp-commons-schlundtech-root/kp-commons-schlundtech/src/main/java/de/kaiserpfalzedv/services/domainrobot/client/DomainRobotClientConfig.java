...
public class DomainRobotClientConfig {
    /** Query param 'json' */
    ...
    @Value("${domainrobot.token}")
    @Setter
    private String apiKey;

    @Bean
    public RequestInterceptor sevenIoDefaultParameters(@Value("${domainrobot.token}") final String apiKey) {
